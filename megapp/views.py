...
from django.shortcuts import render
from megapp.forms import UserForm,UserProfileInfoForm
...
BASE_URL = 'https://kenya.craigslist.org/search/?query={}'
...
def new_search(request):
    ...
    for post in post_listing:
        ...
        if post.find(class_="result-image").get("data-ids"):
            ...
            post_image_url = 'https://image.freepik.com/free-photo/close-up-blank-old-concrete-wall_23-2147856094.jpg'
